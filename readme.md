...
The [Linux binary](fallbacks/linux/xsel) is just a bundled version of [`xsel`](https://linux.die.net/man/1/xsel). The source for the [Windows binary](fallbacks/windows/svg_importer_x86_64.exe) can be found [here](https://github.com/sindresorhus/win-clipboard).
